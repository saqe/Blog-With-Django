...
class DashboardView(PermissionRequiredMixin, TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context["count_published_posts"] = Post.objects.filter(
            published=True).count()
        context["count_featured_posts"] = Post.objects.filter(
            featured=True, published=True).count()
        context["count_pending_posts"] = Post.objects.filter(
