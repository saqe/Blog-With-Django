...
def update_profile(request):
    if request.method == 'POST':
        ...
        if user_form.is_valid() and profile_form.is_valid():
            ...
            profile_form.save()
            messages.success(
                request, f"Dear {request.user.first_name}, your profile have been successfully updated!")
...
def update_profile_password(request):
    if request.method == 'POST':
        ...
        if password_form.is_valid():
            ...
            messages.success(
                request, f"Dear {request.user.first_name}, your password have been successfully updated!")
            return redirect('my-profile')
    else:
...
def update_user_email(request):
    if request.method == 'POST':
        ...
        if email_form.is_valid():
            ...
            messages.success(
                request, f"Dear {request.user.first_name}, your email have been successfully updated!")
            return redirect('my-profile')
    else:
